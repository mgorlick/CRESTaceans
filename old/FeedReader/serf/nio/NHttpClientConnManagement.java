...
public class NHttpClientConnManagement {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 50; i++) {
            AsyncConnectionRequest connRequest = connMgr.requestConnection(); // Get a working connection from the connection manager.
            connRequest.waitFor(); // Wait for the connection request to be completed to the target authority.
            NHttpClientConnection conn = connRequest.getConnection(); // Get the real connection from the connection request.
            if (conn == null) {
    ...
    // Instances of this class are returned by the connection manager.
	...
	// Returns true iff this connection was accepted by the target.
        public boolean isCompleted() {
            return this.completed;
        }
        
	// Set the connection owned by this request.
	...
	// Get the connection owned by this request.
        public NHttpClientConnection getConnection() {
            return this.conn;
        }
        
	// Cancel the process of connection establishment.
        public void cancel() {
            if (this.completed) {
                return;
            }
	...
	// Wait for the connection establishment represented by the request to complete or fail.
