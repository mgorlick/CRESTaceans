...
(define (ogg-packet->bytes o)
  (bytes-append (ogg-packet-packet o)
                (integer->integer-bytes (ogg-packet-bytes o) longsize #t)
                (integer->integer-bytes (ogg-packet-b-o-s o) longsize #t)
                (integer->integer-bytes (ogg-packet-e-o-s o) longsize #t)
                (integer->integer-bytes (ogg-packet-granulepos o) ogg64size #t)
                (integer->integer-bytes (ogg-packet-packetno o) ogg64size #t)))
