...
(defvtx* (_fun _VortexHash-pointer _axlHashForeachFunc3 _axlPointer _axlPointer
               _axlPointer -> _void)
...
(defvtx* (_fun _axlHashFunc _axlEqualFunc _axlDestroyFunc _axlDestroyFunc
               -> _VortexHash-pointer)
  vortex-hash-new-full)

(defvtx* (_fun _VortexHash-pointer _axlPointer _axlDestroyFunc _axlPointer 
               _axlDestroyFunc -> _void)
